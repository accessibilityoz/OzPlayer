...
<head>
    ...
    <title>OzPlayer (PHP Transcript Demo)</title>
    ...
    <script src="./ozplayer-core/mediaelement.min.js?v=4.1" type="text/javascript"></script>

    <!-- required player + required highlights
         (these must go in order: player, highlights) -->
    <link rel="stylesheet" href="./ozplayer-core/ozplayer.min.css?v=4.1" media="all" type="text/css" />
    <!-- (select from blue, purple, pink, red, orange, yellow, green) -->
    <link rel="stylesheet" href="./ozplayer-skin/highlights-pink.css?v=4.1" media="all" type="text/css" />

    <!-- (sample transcript styles) -->
    <link rel="stylesheet" href="transcript.css?v=4.1" media="all" type="text/css" />
...
<body>
    ...
    <details class="ozplayer-expander" open="open">
        ...
        <div id="demo-transcript" class="ozplayer-transcript">
            ...
            <?php
                ...
                $captions = array('en' => '../media/captions-en.vtt');

                //optionally define the additional transcript data the same way
                $transcript = array('en' => '../media/transcript-en.vtt');
    ...
    <script src="./ozplayer-core/ozplayer.min.js?v=4.1" type="text/javascript"></script>
    <!-- <script src="./ozplayer-lang/en.js?v=4.1" type="text/javascript"></script> -->
    <script src="config.js?v=4.1" type="text/javascript"></script>
